...
namespace AmbucareDAL.Models
{
    ...
    public partial class T74069
    {
        public short T_BLD_GROUP_ID { get; set; }
        public string T_SHOT_DESC1 { get; set; }
        public string T_SHOT_DESC2 { get; set; }
        public string T_BLOOD_GORUP { get; set; }
