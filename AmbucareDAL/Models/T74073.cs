...
namespace AmbucareDAL.Models
{
    ...
    public partial class T74073
    {
        public int T_COST_TYPE_DTL_ID { get; set; }
        public Nullable<int> T_COST_TYPE_ID { get; set; }
        ...
        public Nullable<decimal> T_INCHARGABLE { get; set; }
        public Nullable<decimal> T_ACTIVE { get; set; }
