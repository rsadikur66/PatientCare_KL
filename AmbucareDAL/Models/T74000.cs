...
namespace AmbucareDAL.Models
{
    ...
    public partial class T74000
    {
        public decimal T_LABEL_ID { get; set; }
        public string T_FORM_CODE { get; set; }
        public string T_LABEL_NAME { get; set; }
        public string T_LANG1_TEXT { get; set; }
        public string T_LANG2_TEXT { get; set; }
