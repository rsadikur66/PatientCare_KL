...
{
    public class T74010Controller : Controller
    {
        private readonly IT74010 repository;

        public T74010Controller(IT74010 ObjectIRepository)
        {
            repository = ObjectIRepository;
        }

        // GET: T74010
        public ActionResult T74010()
        {
            return View();
        }

        [HttpPost]
        public ActionResult InsertOrUpdate(T74010 Supplier)
        {
            bool status = repository.InsertOrUpdate(Supplier);
        ...
        [HttpPost]
        public ActionResult deleteData(int T_SUPPLI_ID)
        {
            var del = repository.Delete(T_SUPPLI_ID);
