...
{
    public class T74047Controller : Controller
    {
        private readonly IT74047 repository;

        public T74047Controller(IT74047 ObjectIRepository)
        {
        ...
        [HttpPost]
        public ActionResult InsertOrUpdate(T74047 AmbuType)
        {
            bool status = repository.InsertOrUpdate(AmbuType);
        ...
        [HttpPost]
        public ActionResult deleteData(int T_AMBU_TYPE_ID)
        {
            var del = repository.Delete(T_AMBU_TYPE_ID);
