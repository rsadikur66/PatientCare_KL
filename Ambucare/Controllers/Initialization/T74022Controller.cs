...
{
    public class T74022Controller : Controller
    {
        private readonly IT74022 repository;

        public T74022Controller(IT74022 ObjectIRepository)
        {
        ...
        [HttpPost]
        public ActionResult InsertOrUpdate(T74022 ResultGPA)
        {
            bool status = repository.InsertOrUpdate(ResultGPA);
        ...
        [HttpPost]
        public ActionResult deleteData(int T_DOC_DEGREE_ID)
        {
            var del = repository.Delete(T_DOC_DEGREE_ID);
