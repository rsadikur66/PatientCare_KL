...
{
    public class T74012Controller : Controller
    {
        // GET: T74012

        private readonly IT74012 repository;

        public T74012Controller(IT74012 ObjectIRepository)
        {
        ...
        public ActionResult Insert_T74012(T74012 _T74012)
        {
            string mesg = "";

            if (_T74012.T_DETAIL_ID == 0)
            {
            ...
            repository.Insert_T74012(_T74012);
            return Json(mesg, JsonRequestBehavior.AllowGet);
        }
        //For Save and Update End
        //For Deleted Methord Start
        [HttpPost]
        public ActionResult Deleted_T74012(int T_DETAIL_ID)
        {
            var del = repository.Deleted_T74012(T_DETAIL_ID);
