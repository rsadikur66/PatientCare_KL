...
{
    public class T74003Controller : Controller
    {
        // GET: T74003
        private readonly IT74003 repository;

        public T74003Controller(IT74003 ObjectIRepository)
        {
            repository = ObjectIRepository;
        }
        public ActionResult T74003()
        {
            return View();
        }

        [HttpPost]
        public ActionResult GetTypeDataCode()
        {
            try
            {
                var ItemUM = repository.GetTypeData.ToList();
        ...
        public ActionResult Insert_T74003(T74003 _T74003)
        {
            string mesg = "";
           
            if (_T74003.T_ITEM_UM_ID == 0)
            {
            ...
            repository.Insert_T74003(_T74003);
        ...
        [HttpPost]
        public ActionResult Deleted_T74003(int T_ITEM_UM_ID)
        {
            var del = repository.Deleted_T74003(T_ITEM_UM_ID);
