...
{
    public class T74144Controller : Controller
    {
        private readonly IT74144 repository;

        public T74144Controller(IT74144 ObjectIRepository)
        {
        ...
        [HttpPost]
        public ActionResult InsertOrUpdate(T74101 _T74101)
        {
            bool status = repository.InsertOrUpdate(_T74101);
