...
app.controller("T74021Controller", ["$scope", "$filter", "$http", "$window", "T74021Service", "uiGridConstants", "DTOptionsBuilder", "DTColumnBuilder", "LabelService","Data",
    function ($scope, $filter, $http, $window, T74021Service, uiGridConstants, DTOptionsBuilder, DTColumnBuilder, LabelService, Data) {

        //For Gried Data
        $scope.obj = {};
        $scope.obj = Data;
        var Label = T74021Service.getLabel();
        Label.then(function (results) {
            $scope.LabelList = results;
        });
        //For Entry User
        var EntryUser = T74021Service.EntryUser();
        ...
        var labelData = LabelService.getlabeldata('T74021');
        ...
        $scope.Save_Click = function () {
            ...
            if ($scope.obj.T_LANG2_NAME != undefined) {
                if ($scope.obj.T_DOC_DEPT_ID != undefined) {

                    var update = T74021Service.InsertOrUpdate($scope.obj);
                    ...
                    var save = T74021Service.InsertOrUpdate($scope.obj);
        ...
        $scope.Clear=function() {
            $scope.obj.T_DOC_DEPT_ID = '';
            $scope.obj.T_LANG1_NAME = '';
            $scope.obj.T_LANG2_NAME = undefined;

            $scope.obj.T_DOC_DEPT_ID = undefined;
        }

        //For Delete
        $scope.Delete_Click = function () {

            if ($scope.obj.T_DOC_DEPT_ID != null) {
                var dele = T74021Service.deleteData($scope.obj.T_DOC_DEPT_ID);
        ...
        $scope.dtColumns = [
            ...
            DTColumnBuilder.newColumn("RowNumber", "Id").withOption('name', 'T_DOC_DEPT_ID').notVisible(),
        ...
        function someClickHandler(info) {
            $scope.obj.T_DOC_DEPT_ID = info.T_DOC_DEPT_ID;
