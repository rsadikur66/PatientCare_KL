app.controller("T74027Controller",
    ["$scope", "$filter", "$http", "$window", "T74027Service", "LabelService", "T74114Service", "T74114ItemTypeFactory", "T74114ItemNameFactory", "T74027ItemUomListFactory", "uiGridConstants", "DTOptionsBuilder",
        "DTColumnBuilder", "Data",
        function (scope, $filter, $http, $window, T74027Service, LabelService, T74114Service, T74114ItemTypeFactory, T74114ItemNameFactory, T74027ItemUomListFactory, uiGridConstants, DTOptionsBuilder, DTColumnBuilder, Data) {
            //For Instance 
            scope.obj = {};
            scope.obj = Data;
            scope.obj.stockInfo = {};
            ...
            scope.Update_Click = function () {
                ...
                if (scope.obj.Update === '2') {
                    ...
                    if (scope.obj.T_COMPANY_ID != null) {
                        ...
                        alert(scope.getSingleMsg('S0050'));
                    }
                }
            };
            ...
            scope.checkItemUM = function (index, umid, itemid) {
                for (i = 0; i < scope.obj.stockInfo.length; i++) {
                    ...
                    if (itemid == item && umid == um && index != i) {
                        ...
                        alert(scope.getSingleMsg('S0052'));
                    }
                }
            }
          ...
          scope.CheckGridAllData = function (g) {
            ...
            scope.Save_Click = function () {
                if (scope.obj.T_COMPANY_ID != null) {
                    ...
                    //alert("Must select a company!!!");
                    alert(scope.getSingleMsg('S0051'));
                }
            }
        }]);
