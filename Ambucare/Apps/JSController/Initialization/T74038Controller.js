app.controller("T74038Controller", ["$scope", "$filter", "$http", "$window", "T74038Service", "LabelService", "uiGridConstants", "DTOptionsBuilder", "DTColumnBuilder", "Data",
    function (scope, $filter, $http, $window, T74038Service, LabelService, uiGridConstants, DTOptionsBuilder, DTColumnBuilder, Data) {
        //For Instance 
        scope.obj = {};
        scope.obj = Data;
        scope.obj.T_SERV_CHARG_ID = '';
        //EntryUser Function Start
        var EntryUser = T74038Service.EntryUser();
        ...
        var labelData = LabelService.getlabeldata('T74038');
        ...
        scope.Save = function () {
            ...
            var save = T74038Service.Insert_T74038(scope.obj);
        ...
        scope.Delete = function () {
            ...
            if (scope.obj.T_SERV_CHARG_ID != null) {
                if ($window.confirm('Are you sure ?')) {
                    var dele = T74038Service.Deleted_T74038(scope.obj.T_SERV_CHARG_ID);
        ...
        scope.Clear = function () {
            ...
            scope.obj.T_SERV_CHARG_ID = undefined;
        };
        //Clear Function End
        ...
        scope.dtColumns = [
            ...
            DTColumnBuilder.newColumn("T_SERV_CHARG_ID", "Service Charge Id").withOption('name', 'T_SERV_CHARG_ID').notVisible(),
        ...
        function someClickHandler(info) {
            scope.obj.T_SERV_CHARG_ID = info.T_SERV_CHARG_ID;
