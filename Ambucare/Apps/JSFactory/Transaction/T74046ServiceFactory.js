app.factory('ServiceFactory', function ($document, $compile, $filter, $rootScope, $templateCache, $http, uiGridConstants, T74046Service) {
    ...
    return {
        getModal: function (url, data, index) {
            ...
            var dt = T74046Service.ServicePrice();
            ...
            var template = $http.get(url, { cache: $templateCache })
                .then(function (response) {
                    var modal = angular.element([
                        '<div class="modalDoc">',
                        '<div class="win"><span class ="headerText">Service List (Trade Name)</span>',
