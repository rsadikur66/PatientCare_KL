app.factory('T74120PersonNameFactory', function ($document, $compile, $filter, $rootScope, $templateCache, $http, uiGridConstants, T74120Service) {
    $rootScope.obj = {};
    ...
    return {
        getModal: function (url, data, T_EMP_TYP_ID) {
            ...
            var dt = T74120Service.GetPersonName(T_EMP_TYP_ID);
            ...
            scope.myAppScopeProvider = {
                showInfo: function (row) {
                    ...
                    var scope1 = angular.element($("#txtPerson")).scope();
                    scope1.obj.t74080.T_NAME = rodata.T_NAME;
                    var scope2 = angular.element($("#txtNameId")).scope();
                    scope2.obj.t74080.T_EMP_ID = rodata.T_EMP_ID;
                    scope.close();
                }
